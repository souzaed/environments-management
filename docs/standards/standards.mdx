...
| Rank | Standard                                                    | Pain Point Focus |
| :--- | :---                                                        | :---
| 1    | [On Environment Provisioning](environment-provisioning.mdx) | *Communication, FinOps, Visibility* |
| 2    | [On DevOps Toolchain](devops-toolchain.mdx)                 | *Communication, Visibility* |
| 3    | [On Automated Testing](automated-testing.mdx)               | *Automated Testing and Test Data* |
| 4    | [On Path-To-Production](path-to-production.mdx)             | *Stability, integration* |
